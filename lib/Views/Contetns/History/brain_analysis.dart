...
class BrainAnalysis extends StatefulWidget {
  BrainAnalysis({Key? key}) : super(key: key);

  @override
  _BrainAnalysisState createState() => _BrainAnalysisState();
}

class _BrainAnalysisState extends State<BrainAnalysis> {
                                              ...
                                              (rec['status']
                                                  ...
                                                  ? Padding(
                                                      padding: const EdgeInsets
                                                          ...
                                                          vertical: 20.0),
                                                      child: Text(
                                                        "Recommendation : ${recommendationObject['brain-analysis'] ?? ''}",
                                                        style: TextStyle(
                                                            color: colorBlack,
                                                            fontWeight:
                                                                FontWeight.w400,
  ...
  Future<void> getData() async {
    _databaseReference
        .child(FirebaseStructure.BRAINANALYSIS)
